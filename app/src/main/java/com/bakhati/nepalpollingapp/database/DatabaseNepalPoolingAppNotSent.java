package com.bakhati.nepalpollingapp.database;
...
public class DatabaseNepalPoolingAppNotSent extends SQLiteOpenHelper {
    private final static String db_name = "_db_NepalPoolingNotSent.db";
    ...
    public final static String[] COLS_TABLE_MAIN = new String[]{ID_TABLE , TABLE_ID ,TABLE_NAME ,TABLE_DATE ,TABLE_JSON ,  TABLE_STATUS  , DELETE_FLAG };
    static String CREATE_TABLE_MAIN = "Create table if not exists " + TABLE_MAIN + "("
            ...
            + TABLE_DATE + " Text not null ," + TABLE_JSON+ " Text not null ,"  + TABLE_STATUS + " Text not null ," + DELETE_FLAG + " Text not null )";;
    ...
    public DatabaseNepalPoolingAppNotSent(Context context) {
    ...
    public long insertIntoTable_Main(String[] list) {
        ...
        contentValues.put(TABLE_STATUS , list[4]);
        contentValues.put(DELETE_FLAG, list[5]);
    ...
    public int getNotSentFormsRowCount() {
