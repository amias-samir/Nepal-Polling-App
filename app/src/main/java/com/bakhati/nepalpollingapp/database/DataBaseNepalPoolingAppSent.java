 ...
 */
public class DataBaseNepalPoolingAppSent extends SQLiteOpenHelper {
        private final static String db_name = "_db_NepalPoolingSent.db";
    ...
    public DataBaseNepalPoolingAppSent(Context context) {
